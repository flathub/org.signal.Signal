...
This repo hosts the flatpak version of the [Signal-Desktop](https://github.com/signalapp/Signal-Desktop) _beta releases_.
...
The app will be installed as `Signal Beta`. The stable and beta release can be installed side-by-side, and will act as two separate installations.
